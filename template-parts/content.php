...
<article id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
	...
	<p class="post__discuss">
		<a href="https://twitter.com/share?text=<?php echo urlencode(get_the_title()) ?>&amp;url=<?php echo urlencode(get_the_permalink()) ?>&amp;via=namanyayg" onclick="window.open(this.href, 'twitter-share', 'width=550,height=235');return false;">
