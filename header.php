	...
	<header id="masthead" class="site-header">
		<div class="wrap">
			<div class="site-branding">
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri(); ?>/img/symmetrycode.png" alt="">Symmetrycode</a></h1>
				<p class="site-description"><a href="http://namanyayg.com" rel="nofollow designer">Namanyay Goel</a>&rsquo;s thoughts on technology, programming, and everything else.</p>
			</div><!-- .site-branding -->
